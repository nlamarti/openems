...
@ObjectClassDefinition(//
		name = "io.openems.edge.evcs.alfen", //
		description = "Implementation for the Alfen EVCS")
@interface Config {

	@AttributeDefinition(name = "Component-ID", description = "Unique ID of this Component")
	String id() default "io.openems.edge.evcs.alfen0";
	...
	String webconsole_configurationFactory_nameHint() default "io.openems.edge.evcs.alfen [{id}]";
